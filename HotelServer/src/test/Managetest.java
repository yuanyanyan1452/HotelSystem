...
import mork.MorkClient;
import mork.MorkHotel;
import mork.MorkWebMarket;
...
public class Managetest {
	...
	public void testmanage_searchClient(){
		MorkClient client1 = new MorkClient(1);
	...
	public void testmanage_searchHotelWorker(){
		MorkHotel hotel1 = new MorkHotel(100012);
		ManageBLServiceImpl mserviceimpl = new ManageBLServiceImpl();
	...
	public void testmanage_searchMarketWorker(){
		MorkWebMarket webmarket = new MorkWebMarket(1,"1","1");
		ManageBLServiceImpl mserviceimpl = new ManageBLServiceImpl();
